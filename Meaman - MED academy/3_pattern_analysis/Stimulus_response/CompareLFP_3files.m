...
%                 Details.option_data_all(i).post_stim_signals_all_new = post_stim_signals_all ;
           ...
           for ci  = 1 : Nsig              
               ...
               color_i = colors( k ) ;
               if plot_all_signals_line
                     plot( LFP( k ).option_data_all(i).post_stim_signals_time_x_ms ,  post_stim_signals_all( ci , : )   ...
                      , 'Color' , color_i  )
