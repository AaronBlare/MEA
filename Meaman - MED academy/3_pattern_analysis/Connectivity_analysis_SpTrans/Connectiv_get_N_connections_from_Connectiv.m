...
function [ Number_of_Connections , Connection_delays ] = ...
    Connectiv_get_N_connections_from_Connectiv( Connectiv_data  , Global_flags , var )
...
%     Analysis_2_sets_init_parameters
    ...
    Strength_THR = var.Strength_THR ;
    Connects_min_tau_diff_THR = var.Connects_min_tau_diff_THR ;
    SpBur_thr = var.SpBur_thr ;
end
...
%                    tau1= All_files_data_TOTAL_cell{ 2 , fi }.Connectiv_matrix_tau_of_max_M_vector( M_i ); 
                   ...
                   is_Connection_OK_1_delay_non_zero = tau1 >=  Connects_min_tau_diff_THR ;         
                        ...
                        if Check_Spike_Rates && is_Connection_exists
                            ...
                            if Connectiv_data.Total_Spike_Rates( chi ) >= SpBur_thr && ...
                                    Connectiv_data.Total_Spike_Rates( chj ) >= SpBur_thr
