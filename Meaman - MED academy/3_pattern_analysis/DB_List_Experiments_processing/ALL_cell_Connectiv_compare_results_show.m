...
function ALL_cell_Connectiv_compare_results_show( ALL_cell , ANALYSIS_cell , Global_flags , var)
...
Cmp_type_num  = var.Cmp_type_num ;% 1 - sequence, 2 - first file compare
Data_type = var.Conp_type_data_type ;% 1=all data compare, 2=only stimulated channels, 3=only non-stim channels    
...
%            Name_index = strmatch( 'Total_spikes_number' , ALL_cell.Analysis_data_cell_field_names  ) ;
%            dat =cell2mat( ALL_cell.Analysis_data_cell( : ,   Name_index ) );  
           dat =cell2mat( ALL_cell.Analysis_data_cell( : ,   cellfi( 'Total_spikes_number' , ALL_cell.Analysis_data_cell_field_names ) ) );
...
%            Name_index = strmatch( 'Number_of_bursts' , ALL_cell.Analysis_data_cell_field_names  ) ;
           dat =cell2mat( ALL_cell.Analysis_data_cell( : , cellfi( 'Number_of_bursts' , ALL_cell.Analysis_data_cell_field_names ) ) ); 
...
%                 Name_index = strmatch( 'Number_of_Connections' , ALL_cell.Analysis_data_cell_field_names  ) ;
           ...
           Name_index = strmatch( 'New_Diss_connes_percent_of_1s_file' , ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_Names  ) ; 
...
%                     bar( EXP( ex_n ).New_Diss_connes_percent_of_1s_file_all(  ex_list_ctrl_data ) , ctrl_exp_bar_color )  
           ...
           h4 = subplot(Ny,Nx, fi+ DN +  3 );
                      Name_index = strmatch( 'New_conns_percent_of_1st_file' , ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_Names  ) ; 
               dat = cell2mat( ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_cell(: , Name_index ) );
           ...
           h5 = subplot(Ny,Nx, fi+DN + 4 );
                Name_index = strmatch( 'Dissapeared_conns_percent_of_1st_file' , ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_Names  ) ; 
               dat = cell2mat( ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_cell(: , Name_index ) );
           ...
           h6 = subplot(Ny,Nx, fi+DN + 5 );
                 Name_index = strmatch( 'Mean_M_abs_difference_common_connections' , ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_Names  ) ; 
...
%                 title('Stable connections strength change')    
           ...
           h7 = subplot(Ny,Nx, fi+DN + 6 );
                 Name_index = strmatch( 'Mean_M_difference_common_connections' , ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_Names  ) ;                  
...
%                 title('Number_adequate_channels')
                ...
                Name_index = strmatch( 'New_conns_mean_delay' , ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_Names  ) ; 
               dat = cell2mat( ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_cell(: , Name_index ) );
...
%                     sn = Analysis_data_cell_field_names ;
%                     Name_index = strmatch( 'Active_channels_number' , Analysis_data_cell_field_names  ) ;
%                     dat=[];
%                     for fil =  1 : n_files
...
%                 title('Active_channels_number')     
                ...
                Name_index = strmatch( 'Dissapeared_conns_mean_delay' , ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_Names  ) ; 
               dat = cell2mat( ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_cell(: , Name_index ) );
...
%                 hold off  
            ...
            h10 = subplot(Ny,Nx, fi+DN + 9 );
              ...
              Name_index = strmatch( 'Mean_tau_max_difference_common_connections' , ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_Names  ) ; 
               dat = cell2mat( ALL_cell.Comp_type( Cmp_type_num , Data_type  ).Comp_result_cell(: , Name_index ) );
...
%             Name_index = strmatch( 'Small_bursts_number' , ALL_cell.Analysis_data_cell_field_names  ) ;
%            dat =cell2mat( ALL_cell.Analysis_data_cell( : , Name_index ) ); 
%             
% %                 loopIndex =  strmatch( 'Small_bursts_number1' , Comp_type( Cmp_type_num , Data_type  ).Comp_result_SNames  ) ;
