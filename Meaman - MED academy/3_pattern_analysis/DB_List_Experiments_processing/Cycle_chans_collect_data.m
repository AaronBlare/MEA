...
%/////////////// Take Control-Control comapre Tet /////////////////// 
                ...
                % Cycle_chans_collect_data
                      for exp_num_file_n = 1 : 1 : Nexp
                          ...
                          % electrode_sel_param 
                            ...
                            Experiment_number = exp_num_file_n ;
                          ...
                          for ch= 1 : ch_end      
                            ...
                            if Add_data_from_current_channel
                                 ...
                                 if HiLo_Patterns1_2_enough_Low_responses  && HiLo_Patterns2_3_enough_Low_responses
                                          ...
                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channel_difference_mean_ratio_only_active ;
                                          TOTAL_RATE(1).all_exp_diff_mean_ratio_only_active =[TOTAL_RATE(1).all_exp_diff_mean_ratio_only_active ; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channel_difference_mean_only_active ;
                                          TOTAL_RATE(1).all_exp_diff_mean_only_active =[TOTAL_RATE(1).all_exp_diff_mean_only_active ; a ];             

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channel_difference_std_ratio_only_active' ;
                                          TOTAL_RATE(1).all_exp_diff_std_ratio_only_active =[TOTAL_RATE(1).all_exp_diff_std_ratio_only_active; a  ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channel_difference_std_only_active' ;
                                          TOTAL_RATE(1).all_exp_diff_std_only_active =[TOTAL_RATE(1).all_exp_diff_std_only_active; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channels_overlap_only_active ;
                                          TOTAL_RATE(1).all_exp_Channels_overlap_only_active =[TOTAL_RATE(1).all_exp_Channels_overlap_only_active ; a ]; 

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channel_difference_mean_ratio  ;
                                          TOTAL_RATE(1).all_exp_diff_mean_ratio =[TOTAL_RATE(1).all_exp_diff_mean_ratio; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channel_difference_mean  ;
                                          TOTAL_RATE(1).all_exp_diff_mean =[TOTAL_RATE(1).all_exp_diff_mean; a ];             

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channel_difference_std_ratio' ;
                                          TOTAL_RATE(1).all_exp_diff_std_ratio =[TOTAL_RATE(1).all_exp_diff_std_ratio; a  ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channel_difference_std' ;
                                          TOTAL_RATE(1).all_exp_diff_std =[TOTAL_RATE(1).all_exp_diff_std; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channels_overlap  ;
                                          TOTAL_RATE(1).all_exp_Channels_overlap =[TOTAL_RATE(1).all_exp_Channels_overlap ; a ];                                            
                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_3files.Channel_is_active ;
                                 ...
                                 if HiLo_Patterns1_2_enough_High_responses  && HiLo_Patterns2_3_enough_High_responses
                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channel_difference_mean_ratio_only_active ;
                                          TOTAL_RATE(2).all_exp_diff_mean_ratio_only_active =[TOTAL_RATE(2).all_exp_diff_mean_ratio_only_active ; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channel_difference_mean_only_active ;
                                          TOTAL_RATE(2).all_exp_diff_mean_only_active =[TOTAL_RATE(2).all_exp_diff_mean_only_active; a ];             

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channel_difference_std_ratio_only_active' ;
                                          TOTAL_RATE(2).all_exp_diff_std_ratio_only_active =[TOTAL_RATE(2).all_exp_diff_std_ratio_only_active; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channel_difference_std_only_active' ;
                                          TOTAL_RATE(2).all_exp_diff_std_only_active =[TOTAL_RATE(2).all_exp_diff_std_only_active; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channels_overlap_only_active ;
                                          TOTAL_RATE(2).all_exp_Channels_overlap_only_active =[TOTAL_RATE(2).all_exp_Channels_overlap_only_active ; a ]; 

                                           a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channel_difference_mean_ratio  ;
                                          TOTAL_RATE(2).all_exp_diff_mean_ratio =[TOTAL_RATE(2).all_exp_diff_mean_ratio; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channel_difference_mean  ;
                                          TOTAL_RATE(2).all_exp_diff_mean =[TOTAL_RATE(2).all_exp_diff_mean; a ];             

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channel_difference_std_ratio' ;
                                          TOTAL_RATE(2).all_exp_diff_std_ratio =[TOTAL_RATE(2).all_exp_diff_std_ratio; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channel_difference_std' ;
                                          TOTAL_RATE(2).all_exp_diff_std =[TOTAL_RATE(2).all_exp_diff_std; a ];

                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channels_overlap  ;
                                          TOTAL_RATE(2).all_exp_Channels_overlap =[TOTAL_RATE(2).all_exp_Channels_overlap ; a ]; 
                                          
                                          a  = ALL_EXPERIMENTS_FULL_RESULTS_all( exp_num_file_n_fix ).FULL_RESULTS_all( ch ).TOTAL_RATE_High_3files.Channel_is_active ;
