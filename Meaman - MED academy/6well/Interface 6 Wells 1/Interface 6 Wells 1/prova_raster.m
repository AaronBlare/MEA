function prova_raster(start_folder,som,valindex,end_folder1)
...
if som>=1
    ...
    if som==1
        handles.endsubfolder1=strcat(end_folder1,'\',exp_num,s(1),'\',exp_num,s(1),'_PeakDetectionMAT');
    ...
    elseif som==2
        ...
        cd(handles.endsubfolder1);
        copyfile(pwd,handles.peakfolder_s);
        handles.endsubfolder2=strcat(end_folder1,'\',exp_num,s(2),'\',exp_num,s(2),'_PeakDetectionMAT');
    ...
    elseif som==3
        ...
        cd(handles.endsubfolder2);
        copyfile(pwd,handles.peakfolder_s);
        handles.endsubfolder3=strcat(end_folder1,'\',exp_num,s(3),'\',exp_num,s(3),'_PeakDetectionMAT');
    ...
    elseif som==4
        ...
        cd(handles.endsubfolder3);
        copyfile(pwd,handles.peakfolder_s);
        handles.endsubfolder4=strcat(end_folder1,'\',exp_num,s(4),'\',exp_num,s(4),'_PeakDetectionMAT');
    ...
    elseif som==5
        ...
        cd(handles.endsubfolder4);
        copyfile(pwd,handles.peakfolder_s);
        handles.endsubfolder5=strcat(end_folder1,'\',exp_num,s(5),'\',exp_num,s(5),'_PeakDetectionMAT');
    ...
    elseif som==6
        ...
        cd(handles.endsubfolder5);
        copyfile(pwd,handles.peakfolder_s);
        handles.endsubfolder6=strcat(end_folder1,'\',exp_num,s(6),'\',exp_num,s(6),'_PeakDetectionMAT');
