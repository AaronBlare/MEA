function [centers,clusters,errors,ind] = kmeans_clusters2(sD, n_max, c_max, verbose)
...
if nargin < 3 | isempty(c_max) | isnan(c_max), c_max =  25; end
...
for i = 2:n_max, % number of clusters
  ...
  for j = 1:c_max     % run number j for cluster i      
    ...
    [c, k, err] = kmeans_spec('batch', D, i, 100, 0);   % seq   batch
