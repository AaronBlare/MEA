...
% %     
%       % noise_sigma( k ) =  std( xf( T1 : T_start_burst )) / R    ; %Burstless interval
%       %burst_sigma( k ) =  std( xf(T_start_burst : T_end_burst )) / R     ; %Burst interval
%       
...
R = 0.2 : 0.1 : Rmax ;
 [x,y]=meshgrid( F , R );
% surf(x,y, SigmaRF )
surf(x,y, SigmaRF,'EdgeColor','none')
