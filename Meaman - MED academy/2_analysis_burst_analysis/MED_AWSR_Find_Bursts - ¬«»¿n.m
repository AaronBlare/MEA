...
if save_bursts_to_files == 'y'
        ...
        Statistical_ANALYSIS = [ Statistical_ANALYSIS ; Spikes_per_sec ; Nb ] ;
    %         figure
...
DT_bin = DT_BIN_ms ; 
    ...
    eval(['save ' char( finame ) ' Statistical_ANALYSIS Statistical_ANALYSIS_median_values  InteBurstInterval BurstDurations Spikes_per_Burst -mat']); 
